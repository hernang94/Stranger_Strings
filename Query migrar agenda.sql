...
WHERE esqm.Medico_Nombre=m.Nombre AND esqm.Medico_Apellido=m.Apellido AND e.Especialidad_Descripcion=esqm.Especialidad_Descripcion AND esqm.Consulta_Sintomas IS NOT NULL
...
SELECT * FROM STRANGER_STRINGS.Horarios_Agenda